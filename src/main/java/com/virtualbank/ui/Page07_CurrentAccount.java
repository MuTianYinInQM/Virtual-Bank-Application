...
public class Page07_CurrentAccount extends JFrame {
	...
	public Page07_CurrentAccount() {
		super("Current Account Page"); // Set the title of the JFrame
		...
		// id1, balance1, type1, interest1
		createLabel(this.id1 = new JLabel("ID"), 340, 140);
		createLabel(this.balance1 = new JLabel("Balance"), 340, 205);
		createLabel(this.type1 = new JLabel("Type"), 340, 270);
		createLabel(this.interest1 = new JLabel("Interest"), 340, 335);

		Font plainLabelFont = new Font("Arial", Font.PLAIN, 28);

		// idLabel, balanceLabel, typeLabel, interestLabel
		...
		createDataLabel(this.typeLabel = new JLabel("Current Account"), 540, 270, plainLabelFont);
