...
public class Window07b_Consume {
	...
	public Window07b_Consume() {
        ...
        this.window.setTitle("JoyBank - Consume From PiggyBank");
	...
	public static void main(String[] args) {
		...
		Window07b_Consume consume = new Window07b_Consume();
	}
