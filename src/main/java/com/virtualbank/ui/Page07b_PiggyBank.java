...
public class Page07b_PiggyBank {
	...
	public Page07b_PiggyBank() {
		...
		this.consumeButton = new JButton();
...
//		this.balanceLabel.setText("6874350");
		...
		this.typeLabel.setText("Piggy Bank");
...
//		this.interestLabel.setText("624.54");
		...
		// saveButton
		this.window.add(this.saveButton);
		this.saveButton.setBounds(340, 520, 233, 85);
		this.saveButton.setIcon(new ImageIcon("images/save_Button.png"));
		this.saveButton.setBorderPainted(false);
		
		// consumeButton
		this.window.add(this.consumeButton);
		this.consumeButton.setBounds(660, 520, 233, 85);
		this.consumeButton.setIcon(new ImageIcon("images/consume_Button.png"));
		this.consumeButton.setBorderPainted(false);
	...
	public static void main(String[] args) {
		...
		Page07b_PiggyBank page = new Page07b_PiggyBank();
	}
